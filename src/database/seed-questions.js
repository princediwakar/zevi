...
const additionalQuestions = [
  // Product Sense
  {
    ...
    mcq_version: {
      ...
      sub_questions: [
        {
          prompt: "What is the biggest risk in a roommate finder app?",
          difficulty: "intermediate",
          options: [
            {
              text: "Safety/Trust",
              correct: true,
              explanation: "Living with strangers carries high safety risks.",
            },
            {
              text: "Payment processing",
              correct: false,
              explanation: "Solved by other platforms.",
            },
            {
              text: "UI Design",
              correct: false,
              explanation: "Important but not the biggest risk.",
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    mcq_version: {
      ...
      sub_questions: [
        {
          prompt: "Which feature best addresses 'lack of context'?",
          difficulty: "beginner",
          options: [
            {
              text: "AR Guide overlay",
              correct: true,
              explanation: "Provides instant info on art pieces.",
            },
            {
              text: "Ticket booking",
              correct: false,
              explanation: "Logistical only.",
            },
            {
              text: "Cafe locator",
              correct: false,
              explanation: "Amenity only.",
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    mcq_version: {
      ...
      sub_questions: [
        {
          prompt: "What is the primary risk of a paywall?",
          difficulty: "intermediate",
          options: [
            {
              text: "Reduced user growth",
              correct: true,
              explanation: "Paywalls add friction to unparalleled access.",
            },
            {
              text: "Server costs",
              correct: false,
            ...
            {
              text: "Ad revenue increase",
              correct: false,
              explanation:
                "Subscription usually cannibalizes or complements ad revenue.",
            },
          ],
        },
      ],
      ...
      sub_questions: [
        {
          ...
          options: [
            {
              text: "Data accuracy/Tech bugs",
              correct: true,
              explanation: "Always rule out logging errors first.",
            },
            {
              text: "Competitors",
              correct: false,
              explanation: "Too external for step 1.",
            },
            {
              text: "Marketing spend",
              correct: false,
              explanation: "Less likely to cause sudden drop.",
            },
          ],
        },
      ],
  ...
  {
    question_text: "Design a kitchen for the blind.",
    category: "product_sense",
    difficulty: "intermediate",
    company: "General",
  },
  {
    question_text: "How would you improve Google Maps?",
    category: "product_sense",
    difficulty: "beginner",
    company: "Google",
  },
  {
    question_text: "Metric for engagement on Facebook Groups?",
    category: "execution",
    difficulty: "intermediate",
    company: "Meta",
  },
  {
    question_text: "Should Amazon buy a grocery chain?",
    category: "strategy",
    difficulty: "advanced",
    company: "Amazon",
  },
  {
    question_text: "Launch a new product for Spotify.",
    category: "product_sense",
    difficulty: "intermediate",
    company: "Spotify",
  },
  ...
  {
    question_text: "Design a unified messaging inbox.",
    category: "product_sense",
    difficulty: "intermediate",
    company: "Slack",
  },
  {
    question_text: "Estimate daily flights from ATL airport.",
    category: "estimation",
    difficulty: "beginner",
    company: "Delta",
  },
  {
    question_text: "Prioritize features for a Startup MVP.",
    category: "execution",
    difficulty: "intermediate",
    company: "Startup",
  },
  ...
  {
    question_text: "Design a travel app for solo travelers.",
    category: "product_sense",
    difficulty: "intermediate",
    company: "Airbnb",
  },
  {
    question_text: "How to measure success of reaction buttons?",
    category: "execution",
    difficulty: "intermediate",
    company: "LinkedIn",
  },
  {
    question_text: "Should Apple build a search engine?",
    category: "strategy",
    difficulty: "advanced",
    company: "Apple",
  },
  {
    question_text: "Design a better airport experience.",
    category: "product_sense",
    difficulty: "intermediate",
    company: "General",
  },
  {
    question_text: "Estimate revenue of a corner store.",
    category: "estimation",
    difficulty: "beginner",
    company: "General",
  },
  {
    question_text: "Improve the Amazon returns process.",
    category: "product_sense",
    difficulty: "intermediate",
    company: "Amazon",
  },
  {
    question_text: "Key metrics for a dating app?",
    category: "execution",
    difficulty: "beginner",
    company: "Tinder",
  },
  {
    question_text: "Tell me about a mistake you made.",
    category: "behavioral",
    difficulty: "intermediate",
    company: "General",
  },
  {
    question_text: "Design a fitness app for kids.",
    category: "product_sense",
    difficulty: "beginner",
    company: "Nike",
  },
  {
    question_text: "Should Facebook acquire Discord?",
    category: "strategy",
    difficulty: "advanced",
    company: "Meta",
  },
  {
    question_text: "Design a water bottle for hikers.",
    category: "product_sense",
    difficulty: "beginner",
    company: "Yeti",
  },
  {
    question_text: "Estimate number of windows in Seattle.",
    category: "estimation",
    difficulty: "intermediate",
    company: "Microsoft",
  },
  {
    question_text: "Metric for YouTube Recommendations?",
    category: "execution",
    difficulty: "advanced",
    company: "Google",
  },
  {
    question_text: "How to improve Slack notifications?",
    category: "product_sense",
    difficulty: "intermediate",
    company: "Slack",
  },
  {
    question_text: "Design a better umbrella.",
    category: "product_sense",
    difficulty: "beginner",
    company: "General",
  },
